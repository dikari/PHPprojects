...
if ( FCKBrowserInfo.IsAIR )
{
	...
	( function()
	{
		...
		FCK.StartEditor = function()
		{
			...
			window.FCK_InternalCSS			= FCKConfig.BasePath + 'public/css/fck_internal.css' ;
			window.FCK_ShowTableBordersCSS	= FCKConfig.BasePath + 'public/css/fck_showtableborders_gecko.css' ;
